  ...
  class minupage{
    ...
    */
    function first_page($style=''){
      if($this->nowindex<=1){
        return '<ul class="pagination"><a><li class="'.$style.'">'.$this->first_page.'</a></li>';
      }
      return '<ul class="pagination">'.$this->_get_link($this->_get_url(1),$this->first_page,$style);
    }
    ...
    */
    function last_page($style=''){
      ...
      if($this->nowindex>=$this->totalpage){
        return '<li class="'.$style.'"><a>'.$this->last_page.'</a></li></ul>';
      }
      return $this->_get_link($this->_get_url($this->totalpage),$this->last_page,$style).'</ul>';
    }
      ...
      for($i=$begin;$i<$begin+$this->pagebarnum;$i++){
        if($i<=$this->totalpage){
          if($i!=$this->nowindex)
            ...
            $return.=$this->_get_text('<li class="'.$nowindex_style.'"><a style="background-color: #e7e7e7;">'.$i.'</a></li>');
        }else{
          break;
        }
        $return.="\n";
    ...
    function show($mode=1,$url=''){
      ...
      switch ($mode){
        ...
        case '5':
          $this->first_page='首页';
          $this->last_page='尾页';
          return $this->first_page().$this->nowbar().$this->last_page();
          break;
      }
    }
